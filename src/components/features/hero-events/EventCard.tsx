...
export const EventCard = ({ event, icon, accentColor, index }: EventCardProps) => {
  return (
    <motion.div
    ...
    >
      ...
      <div className="relative h-full flex flex-col p-6 md:p-8 rounded-3xl glass-surface border border-white/5 bg-[#0D0D0D]/50 backdrop-blur-sm group-hover:border-white/10 transition-colors overflow-hidden">
