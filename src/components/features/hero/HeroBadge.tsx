...
export const HeroBadge = () => {
  return (
    ...
    >
      <div className="md:hidden absolute top-0 left-0 w-6 h-6 sm:w-8 sm:h-8 border-l-2 border-t-2 border-primary/30 rounded-tl-lg" />
      <div className="md:hidden absolute bottom-0 right-0 w-6 h-6 sm:w-8 sm:h-8 border-r-2 border-b-2 border-accent/30 rounded-br-lg" />
