...
export const unifiedEvents: UnifiedEvent[] = [
  ...
  },
  {
    id: 'cultural-night',
    name: 'Cultural Night',
    tagline: 'A celebration of art and talent',
    description: 'Grand finale cultural performances featuring dance, music, drama, and more from talented students across the campus.',
    category: 'cultural',
    schedule: {
      day: 2,
      startTime: '19:00',
